...
func ValidatePodsSeedName() {
	It("Validate no pods using seed name", reportxml.ID("71389"), Label("ValidatePodsSeedName", "seed-target-diff"), func() {
...
func ValidateClusterHostname() {
	It("Validate upgraded cluster hostname", reportxml.ID("71390"), Label("ValidateHostName", "seed-target-diff"), func() {
...
func ValidateSeedHostnameRefLogs() {
	It("Validate no seed hostname references in pod logs", reportxml.ID("71392"), Label("ValidateSeedRefPodLogs", "seed-target-diff"), func() {
...
func ValidateSeedRefMetrics() {
	It("Validate no seed references in the exported metrics", reportxml.ID("71397"), Label("ValidateMetrics", "seed-target-diff"), func() {
...
func ValidateSeedRefLogs() {
	It("Validate no seed references in the exported logs", reportxml.ID("71398"), Label("ValidateLogs", "seed-target-diff"), func() {
